...
shared JavaWrappedProperty<Integer, JInteger> integerWrappedProperty(JObjectProp<JInteger> jProp, Integer|Unset initValue = unset) {
	return  JavaWrappedProperty(jProp, integerC2J.convert, integerJ2C.convert, initValue);
}
